...
ui <- fluidPage(
  ...
  sidebarPanel( 
    ...
    selectInput("bedrooms", label="How many bedrooms?", 
                choices = c("Any", unique(test$bedrooms))),
...
server <- function(input,output){
  ...
  output$plot2<-renderPlot({
    ...
    bedroom_str <- paste0("Bedrooms:", input$bedrooms, sep=" ")
    ...
    ggplot(data=reac_data, aes(x=price, 
      ...
      labs(title = "Prediction vs. Actual prices in Athene",
           subtitle = paste0(acc_str, cent_str, bedroom_str, bathrooms_str, sep=" ")) +
      ylab("Predicted price") +
      xlab("Actual price")
