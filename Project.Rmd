...
We now have transformed the data types of the most variables in order to make the data set even cleaner. 

### Readjust NA values 

In a next step we will further manipulate the data set. In specific we will correct the NA values in cases in which we can estimate the value. 
